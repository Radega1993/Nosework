            ...
            <div className="container mx-auto px-4 md:px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <h3 className="text-2xl font-bold text-white mb-4">Nosework Trial Community</h3>
                    ...
                    {/* Enlaces Principales */}
                    <div>
                        <h4 className="text-white font-semibold mb-4">Principal</h4>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-500">
                    <p>&copy; {currentYear} Nosework Trial Community. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    );
